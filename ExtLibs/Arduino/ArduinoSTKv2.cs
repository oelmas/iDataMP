    ...
    public class ArduinoSTKv2 : SerialPort, IArduinoComms
    {
        ...
        public bool connectAP()
        {
            ...
            while (a < 5)
            {
                ...
                try
                {
                    if (temp[0] == 6 && temp[1] == 0 && temp.Length == 2) return true;
                }
                catch
                {
                }
        ...
        {
            if (!IsOpen) throw new Exception("Port Closed");
            var data = new byte[length];
        ...
        public bool setaddress(int address)
        {
            ...
            if (address % 2 == 1) throw new Exception("Address must be an even number");
        ...
        private byte[] readpacket()
        {
            ...
            while (count < a && a < temp.Length)
            {
                ...
                if (count >= 5) mes[count - 5] = temp[count];
