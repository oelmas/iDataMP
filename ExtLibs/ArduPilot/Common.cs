...
namespace MissionPlanner.ArduPilot
{
    ...
    public class Common
    {
        ...
        public static readonly List<Tuple<motor_frame_class, motor_frame_type?>> ValidList =
...
union px4_custom_mode {
    ...
    float data_float;
                ...
                {
                    new KeyValuePair<int, string>((int)PX4_CUSTOM_MAIN_MODE.PX4_CUSTOM_MAIN_MODE_MANUAL << 16,
                        "Manual"),
            ...
            if (firmware == Firmwares.ArduTracker)
            {
                var temp = new List<KeyValuePair<int, string>>();
        ...
        public static string speechConversion(MAVState MAV, string input)
        {
            ...
            input = input.Replace("{mode}", MAV.cs.mode);
            ...
            try
            {
                ...
                var posible = input.Split(new[] { "{", "}" }, StringSplitOptions.RemoveEmptyEntries);
