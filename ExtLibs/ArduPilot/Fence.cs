    ...
    public class Fence
    {
        ...
        public void DownloadFence(MAVLinkInterface port, Action<int, string> progress = null)
        {
            var list = Task.Run(async () => await mav_mission
                .download(port, port.MAV.sysid, port.MAV.compid, MAVLink.MAV_MISSION_TYPE.FENCE, progress)
        ...
        public void UploadFence(MAVLinkInterface port, Action<int, string> progress = null)
        {
            ...
            mav_mission.upload(port, port.MAV.sysid, port.MAV.compid, MAVLink.MAV_MISSION_TYPE.FENCE, fence, progress)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
