...
namespace MissionPlanner.ArduPilot.Mavlink
{
   ...
   */
        ...
        private gimbal_status_t _status;
        ...
        {
            var cosPhi_2 = Utils.cosf(roll / 2);
            var sinPhi_2 = Utils.sinf(roll / 2);
            var cosTheta_2 = Utils.cosf(pitch / 2);
            var sinTheta_2 = Utils.sinf(pitch / 2);
            var cosPsi_2 = Utils.cosf(yaw / 2);
            var sinPsi_2 = Utils.sinf(yaw / 2);
