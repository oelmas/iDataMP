...
namespace BSE.Windows.Forms
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        private static readonly int MarginInset;
        private static readonly Blend MenuItemBlend;
        private static readonly Blend ButtonBlend;
        ...
        static BseRenderer()
        {
            ...
            {
                new Rectangle(8, 0, 2, 2), new Rectangle(8, 4, 2, 2), new Rectangle(8, 8, 2, 2),
                new Rectangle(4, 4, 2, 2), new Rectangle(4, 8, 2, 2), new Rectangle(0, 8, 2, 2)
            };
        }
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            else
            {
                ...
                var buttonBounds = new Rectangle(Point.Empty, item.Size);
                if (IsZeroWidthOrHeight(buttonBounds)) return;
                var graphics = e.Graphics;
                var colorTable = ColorTable as ProfessionalColorTable;
                if (colorTable != null)
                    using (var antiAlias = new UseAntiAlias(graphics))
                    {
                        var buttonRectangle = GetButtonRectangle(buttonBounds);
        ...
        protected override void OnRenderSplitButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            else
            {
                ...
                var buttonBounds = new Rectangle(Point.Empty, item.ButtonBounds.Size);
                if (IsZeroWidthOrHeight(buttonBounds)) return;
                var graphics = e.Graphics;
                var colorTable = ColorTable as ProfessionalColorTable;
                if (colorTable != null)
                    ...
                    {
                        var buttonRectangle = GetButtonRectangle(buttonBounds);
                        var dropDownButtonBounds = new Rectangle(item.DropDownButtonBounds.Location,
                            item.DropDownButtonBounds.Size);
                        var dropDownButtonRectangle = GetButtonRectangle(dropDownButtonBounds);
                        ...
                        if (item.Selected && item.Pressed == false && item.ButtonPressed == false)
                        {
                            ...
                            RenderButton(graphics, dropDownButtonRectangle,
                                colorTable.MenuItemTopLevelSelectedGradientBegin);
                            ...
                            DrawButtonBorder(graphics, dropDownButtonRectangle,
                        ...
                        if (item.ButtonPressed)
                        {
                            ...
                            DrawInnerButtonBorder(graphics, dropDownButtonRectangle,
                                colorTable.ButtonSelectedHighlightBorder);
                        ...
                        if (e.Item.Owner is MenuStrip)
                            DrawArrow(new ToolStripArrowRenderEventArgs(graphics, item, dropDownButtonBounds,
                                colorTable.MenuItemText, ArrowDirection.Down));
                        if (e.Item.Owner is StatusStrip)
                            DrawArrow(new ToolStripArrowRenderEventArgs(graphics, item, dropDownButtonBounds,
                                colorTable.StatusStripText, ArrowDirection.Down));
                        if (e.Item.Owner is ToolStrip)
                            DrawArrow(new ToolStripArrowRenderEventArgs(graphics, item, dropDownButtonBounds,
                                colorTable.ToolStripText, ArrowDirection.Down));
                    }
                else
                    base.OnRenderDropDownButtonBackground(e);
            }
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            var colorTable = ColorTable as ProfessionalColorTable;
            if (colorTable != null)
                using (var useAntiAlias = new UseAntiAlias(graphics))
                {
                    if (e.ToolStrip is MenuStrip)
                    {
                        if (item.Selected && item.Pressed == false)
                        {
                            ...
                            ControlPaint.DrawBorder(e.Graphics, bounds, colorTable.MenuItemTopLevelSelectedBorder,
                        ...
                        if (item.Pressed)
                        {
                            ...
                            var innerBorderRectangle = bounds;
                            innerBorderRectangle.Inflate(-1, -1);
                            ControlPaint.DrawBorder(e.Graphics, innerBorderRectangle,
                                ColorTable.ButtonSelectedHighlightBorder, ButtonBorderStyle.Solid);
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
            if (ColorTable.UseSystemColors == false)
            {
                ...
                if (colorTable != null)
                {
                    ...
                    {
                        if (colorTable.MenuItemText != Color.Empty) e.TextColor = colorTable.MenuItemText;
                    }
                    else if (e.ToolStrip is StatusStrip) // && (e.Item.Selected == false) && e.Item.Pressed == false)
                    {
                        if (colorTable.StatusStripText != Color.Empty) e.TextColor = colorTable.StatusStripText;
                    }
                    ...
                    {
                        if (colorTable.ToolStripText != Color.Empty) e.TextColor = colorTable.ToolStripText;
                    }
                }
            }
        ...
        protected override void OnRenderOverflowButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (item.Selected == false && item.Pressed == false)
            {
                ...
                {
                    var graphics = e.Graphics;
                    var bRightToLeft = item.RightToLeft == RightToLeft.Yes;

                    var bOrientation = e.ToolStrip.Orientation == Orientation.Horizontal;
                    var arrowRectangle = Rectangle.Empty;
                    if (bRightToLeft)
                        arrowRectangle = new Rectangle(0, item.Height - 8, 9, 5);
                    else
                        arrowRectangle = new Rectangle(item.Width - 12, item.Height - 8, 9, 5);

                    var arrowDirection = bOrientation ? ArrowDirection.Down : ArrowDirection.Right;
                    var x = bRightToLeft && bOrientation ? -1 : 1;
                    ...
                    {
                        x = bRightToLeft ? -2 : 0;
                        RenderOverflowButtonLine(graphics, colorTable.ToolStripText, arrowRectangle.Right - 6,
                            arrowRectangle.Y - 2, arrowRectangle.Right - 2, arrowRectangle.Y - 2);
                        RenderOverflowButtonLine(graphics, colorTable.ToolStripGradientMiddle,
                            arrowRectangle.Right - 5 + x, arrowRectangle.Y - 1, arrowRectangle.Right - 1 + x,
                            arrowRectangle.Y - 1);
                    }
                    else
                    {
                        RenderOverflowButtonLine(graphics, colorTable.ToolStripText, arrowRectangle.X, arrowRectangle.Y,
                            arrowRectangle.X, arrowRectangle.Bottom - 1);
                        RenderOverflowButtonLine(graphics, colorTable.ToolStripGradientMiddle, arrowRectangle.X + 1,
                            arrowRectangle.Y + 1, arrowRectangle.X + 1, arrowRectangle.Bottom);
                    }
                }
            }
        }
        ...
        {
            if (ColorTable.UseSystemColors == false) e.Item.ForeColor = ColorTable.RaftingContainerGradientBegin;
        ...
        {
            var graphics = e.Graphics;
            var toolStrip = e.ToolStrip as StatusStrip;
            if (toolStrip != null)
            {
                var sizeGripBounds = toolStrip.SizeGripBounds;
                if (IsZeroWidthOrHeight(sizeGripBounds) == false)
                {
                    var rectanglesLight = new Rectangle[baseSizeGripRectangles.Length];
                    var rectanglesDark = new Rectangle[baseSizeGripRectangles.Length];
                    for (var i = 0; i < baseSizeGripRectangles.Length; i++)
                    {
                        var rectangleDark = baseSizeGripRectangles[i];
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else
            {
                ...
                var backgroundRectangle = new Rectangle(0, 0, e.ToolStrip.Width, e.ToolStrip.Height);
                var innerRectangle = backgroundRectangle;
                ...
                if (backgroundRectangle.Width > 0 && backgroundRectangle.Height > 0)
                {
                    ...
                    {
                        using (var outerBrush = new SolidBrush(ColorTable.StatusStripGradientEnd))
                        {
                            e.Graphics.FillRectangle(outerBrush, backgroundRectangle);
                        }

                        var y2 = backgroundRectangle.Height / 2;
                        var upperRectangle = new Rectangle(backgroundRectangle.X, backgroundRectangle.Y,
                            backgroundRectangle.Width, y2);
                        upperRectangle.Height += 1;
                        using (var innerRectangleBrush = new LinearGradientBrush(
                                   upperRectangle,
                        ...
                        var lowerRectangle = new Rectangle(backgroundRectangle.X, backgroundRectangle.Height - y2,
                            backgroundRectangle.Width, y2);
                    ...
                    {
                        using (var outerBrush = new SolidBrush(ColorTable.MenuStripGradientEnd))
                        {
                            e.Graphics.FillRectangle(outerBrush, backgroundRectangle);
                        }

                        var y2 = backgroundRectangle.Height / 3;
                        var lowerRectangle = new Rectangle(backgroundRectangle.X, backgroundRectangle.Y,
                            backgroundRectangle.Width, y2);
                    ...
                    {
                        using (var outerBrush = new SolidBrush(ColorTable.ToolStripGradientEnd))
                        {
                            e.Graphics.FillRectangle(outerBrush, backgroundRectangle);
                        }
        ...
        {
            using (var graphicsPath = GetBackgroundPath(buttonBounds, 3))
            {
                using (var backBrush = new LinearGradientBrush(buttonBounds,
                           gradientColor,
                           Color.Transparent,
                           LinearGradientMode.Vertical))
                {
        ...
        {
            using (var itemPath = GetBackgroundPath(buttonBounds, 3))
            {
                using (var itemPen = new Pen(borderColor))
                {
        ...
        {
            var innerButtonRectangle = buttonBounds;
            innerButtonRectangle.Height -= 1;
            innerButtonRectangle.Width -= 1;
            using (var innerBorderPath = GetBackgroundPath(innerButtonRectangle, 3))
            {
                using (var itemPen = new Pen(innerBorderColor))
                {
