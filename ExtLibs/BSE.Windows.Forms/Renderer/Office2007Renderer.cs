...
namespace BSE.Windows.Forms
{
	...
	public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static readonly Blend StatusStripBlend;
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            if (ColorTable.UseSystemColors == false)
            {
                ...
                if (colorTable != null)
                {
                    if (e.Item.Owner.GetType() == typeof(MenuStrip) && e.Item.Selected == false &&
                        e.Item.Pressed == false)
                        if (colorTable.MenuItemText != Color.Empty)
                            e.ArrowColor = colorTable.MenuItemText;
                    if (e.Item.Owner.GetType() == typeof(StatusStrip) && e.Item.Selected == false &&
                        e.Item.Pressed == false)
