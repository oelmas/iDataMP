...
define(['./when-b43ff45e', './Check-d404a0fe', './Math-ff83510d', './RuntimeError-bf10f3d5', './WebGLConstants-56de22c0', './ComponentDatatype-560e725a', './IndexDatatype-f0ba7ec6', './createTaskProcessorWorker'], function (when, Check, _Math, RuntimeError, WebGLConstants, ComponentDatatype, IndexDatatype, createTaskProcessorWorker) {
    'use strict';
