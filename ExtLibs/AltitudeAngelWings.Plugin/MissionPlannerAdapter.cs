...
namespace AltitudeAngelWings.Plugin
{
    public class MissionPlannerAdapter : IMissionPlanner
    {
        ...
        public MissionPlannerAdapter(IUiThreadInvoke uiThreadInvoke, IMap flightDataMap, IMap flightPlanningMap,
            Func<IList<Locationwp>> getFlightPlan, ISettings settings)
        {
        ...
        {
            return ShowMessageBox(message, Resources.MissionPlannerAdapterNotifyMessageTitle);
        }
        ...
        public Task Disarm()
        {
            return MainV2.comPort.doARMAsync(MainV2.comPort.MAV.sysid, MainV2.comPort.MAV.compid, false);
        }

        public Task ShowMessageBox(string message, string caption = null)
        {
            if (string.IsNullOrEmpty(caption)) caption = Resources.MissionPlannerAdapterMessageBoxDefaultCaption;
