...
namespace AltitudeAngelWings.Plugin
{
    public class AltitudeAngelPlugin : MissionPlanner.Plugin.Plugin
    {
        ...
        public override bool Loaded()
        {
            ...
            if (_enabled) EnableAltitudeAngel();
            return true;
        }
        ...
        private void AskToEnableAltitudeAngel(bool explicitClick = false)
        {
            ...
            if (explicitClick) text = Resources.ExplicitClickPrefix + text;
        ...
        private void EnableAltitudeAngel()
        {
            ...
            if (!service.IsSignedIn) service.SignInAsync();
        }
        ...
        {
            if (!_enabled) AskToEnableAltitudeAngel(true);
            if (!_enabled) return;
            EnableAltitudeAngel();
