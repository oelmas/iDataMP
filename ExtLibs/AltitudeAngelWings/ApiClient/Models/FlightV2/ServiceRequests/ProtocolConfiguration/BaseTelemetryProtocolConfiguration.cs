...
namespace AltitudeAngelWings.ApiClient.Models.FlightV2.ServiceRequests.ProtocolConfiguration
{
    ...
    public abstract class BaseTelemetryProtocolConfiguration
    {
        ...
        [JsonProperty("type")] public TelemetryProtocolType Type { get; }
        ...
        /// <summary>
        ///     Gets the hash code of the properties of the <see cref="BaseTelemetryProtocolConfiguration" /> that are set by the
        ///     user/flight creator.
        /// </summary>
        [JsonIgnore]
        public abstract int UserPropertiesHash { get; }

        public virtual bool IsEquivalentTo(BaseTelemetryProtocolConfiguration configuration)
        {
