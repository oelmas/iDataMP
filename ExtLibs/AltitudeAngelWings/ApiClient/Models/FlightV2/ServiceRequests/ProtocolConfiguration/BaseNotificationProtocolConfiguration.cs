...
namespace AltitudeAngelWings.ApiClient.Models.FlightV2.ServiceRequests.ProtocolConfiguration
{
    ...
    public abstract class BaseNotificationProtocolConfiguration
    {
        ...
        [JsonProperty("type")] public NotificationProtocolType Type { get; }

        [JsonIgnore] public abstract string Description { get; }

        /// <summary>
        ///     Gets properties of the <see cref="BaseNotificationProtocolConfiguration" /> that are set by the user/flight
        ///     creator.
        /// </summary>
        /// <returns>An object containing the user-set properties.</returns>
        [JsonIgnore]
        public abstract object UserProperties { get; }

        /// <summary>
        ///     Gets the hash code of properties of the <see cref="BaseNotificationProtocolConfiguration" /> that are set by the
        ///     user/flight creator.
        /// </summary>
        [JsonIgnore]
        public abstract int UserPropertiesHash { get; }

        public virtual bool IsEquivalentTo(BaseNotificationProtocolConfiguration configuration)
        {
    ...
    public class
        BaseNotificationProtocolConfigurationConverter : JsonCreationConverter<BaseNotificationProtocolConfiguration>
    {
        protected override BaseNotificationProtocolConfiguration Create(Type objectType, JObject jObject)
        {
            var typeString = jObject.GetStringIgnoreCase("type");
