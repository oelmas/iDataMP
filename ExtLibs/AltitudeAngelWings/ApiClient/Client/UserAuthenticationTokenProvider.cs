...
namespace AltitudeAngelWings.ApiClient.Client
{
    public class UserAuthenticationTokenProvider : ITokenProvider
    {
        ...
        public UserAuthenticationTokenProvider(ISettings settings, IHttpClientFactory clientFactory,
            IAuthorizeCodeProvider provider, IMessagesService messagesService)
        {
            _settings = settings;
        ...
        public async Task<string> GetToken(CancellationToken cancellationToken)
        {
            ...
            try
            {
                if (_settings.TokenResponse.IsValidForAuth()) return _settings.TokenResponse.AccessToken;
        ...
        private async Task<TokenResponse> MakeTokenRequest(Func<HttpContent> postBody,
