...
namespace AltitudeAngelWings.Service.AltitudeAngelTelemetry.Encryption
{
    public class UdpTelemetryDatagram
    {
        ...
        {
            if (payload.Length > short.MaxValue) throw new ArgumentException(payload.Length.ToString());
        ...
        /// </summary>
        public bool IsEncrypted => (Header.Flags & DatagramFlags.Encrypted) == DatagramFlags.Encrypted;
