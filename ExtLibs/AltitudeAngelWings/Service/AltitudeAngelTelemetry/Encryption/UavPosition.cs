...
namespace AltitudeAngelWings.Service.AltitudeAngelTelemetry.Encryption
{
    ...
    public struct UavPosition
    {
        ...
        /// </summary>
        public ushort GpsTimestampOffset { get; set; }
