...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            lblVersion.Text = "GÖKALP Version: " + version.Major.ToString() + "."
            ...
            MyView = new MainSwitcher(this.panelView);
            ...
            //var baudRates = new[] { { "110" = 110 }, 300, 600, 1200, 2400, 4800, 9600, 14400, 19200, 38400, 57600, 115200, 128000, 256000 };

            _connectionControl.CMB_baudrate.Click += CMB_baudrate_Click;
            ...
            {
                _connectionControl.CMB_baudrate.SelectedIndex = -1; // 8
        ...
        private void CMB_baudrate_Click(object sender, EventArgs e)
        {
            object[] selectedBaudRate = new ComboboxItem[]
            {
                new ComboboxItem { Text = "110", Value = 110 },
                new ComboboxItem { Text = "300", Value = 300 },
                new ComboboxItem { Text = "600", Value = 600 },
                new ComboboxItem { Text = "1200", Value = 1200 },
                new ComboboxItem { Text = "2400", Value = 2400 },
                new ComboboxItem { Text = "4800", Value = 4800 },
                new ComboboxItem { Text = "9600", Value = 9600 },
                new ComboboxItem { Text = "14400", Value = 14400 },
                new ComboboxItem { Text = "19200", Value = 19200 },
                new ComboboxItem { Text = "38400", Value = 38400 },
                new ComboboxItem { Text = "57600", Value = 57600 },
                new ComboboxItem { Text = "115200", Value = 115200 },
                new ComboboxItem { Text = "128000", Value = 128000 },
                new ComboboxItem { Text = "256000", Value = 256000 }

            };


            _connectionControl.CMB_baudrate.Items.AddRange(selectedBaudRate);
        }
        ...
        private void MainMenu_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            //MainMenu.BackColor = Color.Aquamarine;
        ...
        private void btnFullView_Click(object sender, EventArgs e)
        {
            ...
            {
                this.WindowState = FormWindowState.Maximized;
                btnFullView.IconChar = IconChar.WindowRestore;
            }
            else
            {
                this.WindowState = FormWindowState.Normal;
                btnFullView.IconChar = IconChar.WindowMaximize;
            }
            

        }

        private void btnHideSideMenu_Click_1(object sender, EventArgs e)
        {
            if (isSideMenuMax)
            {

                panelSideMenu.Visible = false;
                panelSideMenuMin.Visible = true;
                isSideMenuMax = !isSideMenuMax;
                //this.btnHideSideMenu.IconChar = FontAwesome.Sharp.MaterialIcons.ArrowExpandAll;
        ...
        private void btnShowSideMenu_Click(object sender, EventArgs e)
        {
            ...
            panelSideMenuMin.Visible = false;
            isSideMenuMax = !isSideMenuMax;
        ...
        private bool isSideMenuMax = true;

        #region Wide Side Menu
        ...
        {
            if (MessageBox.Show("Are you sure to log out GÖKALP ?","Warning",
        ...
        #region Mini Side Menu

        private void btnDataMin_Click(object sender, EventArgs e)
        {
            MyView.ShowScreen("FlightData");
            // save config
            SaveConfig();
        ...
        private void btnSetupMin_Click(object sender, EventArgs e)
        {
            if (Settings.Instance.GetBoolean("password_protect") == false)
            {
                MyView.ShowScreen("HWConfig");
        ...
        private void btnPlanMin_Click(object sender, EventArgs e)
        {
            MyView.ShowScreen("FlightPlanner");
        ...
        private void btnConfigMin_Click(object sender, EventArgs e)
        {
            if (Settings.Instance.GetBoolean("password_protect") == false)
            {
                MyView.ShowScreen("SWConfig");
        ...
        private void btnSimulationMin_Click(object sender, EventArgs e)
        {
            MyView.ShowScreen("Simulation");
        }

        private void btnHelpMin_Click(object sender, EventArgs e)
        {
            MyView.ShowScreen("Help");
        }
        
        private void btnLogoutMin_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure to log out GÖKALP ?","Warning",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
        ...
        {
            lblFirstName.Text = UserLoginCache.UserName+" "+ UserLoginCache.UserLastName;
            lblEmail.Text = UserLoginCache.UserEmail;
            lblTitle.Text = UserLoginCache.UserPosition;
        }
        ...
        private void UserRoleMenus()
        {
            var userRole = UserLoginCache.UserTypeId;
            if (userRole == 1)
            {
                btnConfig.Visible = false;
                btnConfigMin.Visible = false;
                btnSetup.Visible = false;
                btnSetupMin.Visible = false;
            }
        ...
        private static void LoadBaudRates()
        {
            _connectionControl.CMB_baudrate.Items.AddRange(new object[]
            {
                "115200",
                "57600",
                "38400",
