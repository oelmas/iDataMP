...
namespace MissionPlanner.Controls.Icon
{
    public class Zoom : Icon
    {
        internal override void doPaint(Graphics g)
        {
            ...
            //lr
            g.DrawLine(LinePen, arcrect.X, arcrect.Y + arcrect.Height / 2, arcrect.X + arcrect.Width,
                arcrect.Y + arcrect.Height / 2);

            //ud
            g.DrawLine(LinePen, arcrect.X + arcrect.Width / 2, arcrect.Y, arcrect.X + arcrect.Width / 2,
                arcrect.Y + arcrect.Height);
        }
    }
}