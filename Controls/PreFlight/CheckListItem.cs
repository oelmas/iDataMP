...
namespace MissionPlanner.Controls.PreFlight
{
    public class CheckListItem
    {
        ...
        {
            get => _TrueColor.Name;
            set => _TrueColor = Color.FromName(value);
        }
        ...
        {
            get => _FalseColor.Name;
            set => _FalseColor = Color.FromName(value);
        }
        ...
        private PropertyInfo Item { get; set; }
        ...
        public double GetValue
        {
            get
            {
                ...
                if (Name == "PARAM") return HandleParam();
