...
namespace MissionPlanner.Controls
{
    public partial class DigitalSkyUI : UserControl, IActivate
    {
        ...
        public async void test()
        {
            ...
            var myuserid = login["id"].Value<long>();
            ...
            var flyDronePermissionApplication_application =
                await "https://digitalsky-uat.centralindia.cloudapp.azure.com:8080"
                    .AppendPathSegment(
            ...
            var uploadlog = await "https://digitalsky-uat.centralindia.cloudapp.azure.com:8080"
                ...
                .PostMultipartAsync(mp =>
                    mp.AddFile("flightLogDocument", @"C:\Users\mich1\Downloads\permissionArtifact"))
        ...
        private async void Cmb_drones_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var displaylist =
                applist.Where(a => a.Value["status"].Value<string>().Contains("APPROVED"))
                    .Select(a => new KeyValuePair<string, JToken>(a.Key, a.Value));
        ...
        private void Cmb_applications_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var flyArea = perm["flyArea"].Children().Select(a =>
                new PointLatLngAlt(a["latitude"].Value<double>(), a["longitude"].Value<double>(),
                    perm["maxAltitude"].Value<double>() / 3.281, perm["id"].Value<string>()));
            ...
            foreach (var pointLatLngAlt in flyArea) _markeroverlay.Markers.Add(new GMapMarkerWP(pointLatLngAlt, ""));
        ...
        private async void But_dlartifact_Click(object sender, EventArgs e)
        {
            ...
            var ftp = new MAVFtp(MainV2.comPort, (byte)MainV2.comPort.sysidcurrent,
