...
namespace MissionPlanner.Controls
{
    public partial class SerialOutputNMEA : Form
    {
        ...
        private static ICommsSerial NmeaStream = new TcpSerial();
        ...
        private void mainloop()
        {
            ...
            while (threadrun)
                try
                {
                    ...
                    //GGA
                    var lat = (int)MainV2.comPort.MAV.cs.lat +
                              (MainV2.comPort.MAV.cs.lat - (int)MainV2.comPort.MAV.cs.lat) * .6f;
                    var lng = (int)MainV2.comPort.MAV.cs.lng +
                    ...
                    var line = string.Format(CultureInfo.InvariantCulture,
                        ...
                        Math.Abs(lat * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lat < 0 ? "S" : "N",
                        Math.Abs(lng * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lng < 0 ? "W" : "E",
                    ...
                    line = string.Format(CultureInfo.InvariantCulture,
                        ...
                        Math.Abs(lat * 100).ToString("0.00", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lat < 0 ? "S" : "N",
                        Math.Abs(lng * 100).ToString("0.00", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lng < 0 ? "W" : "E",
                    ...
                    */
                    ...
                    line = string.Format(CultureInfo.InvariantCulture,
                        ...
                        DateTime.Now.ToUniversalTime(), "A",
                        Math.Abs(lat * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lat < 0 ? "S" : "N",
                        Math.Abs(lng * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.lng < 0 ? "W" : "E",
                        (MainV2.comPort.MAV.cs.groundspeed * 1.943844).ToString("0.0", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.groundcourse.ToString("0.0", CultureInfo.InvariantCulture), DateTime.Now,
                        0, "E", "A");
                    ...
                    if (counter % 20 == 0 && HomeLoc.Lat != 0 && HomeLoc.Lng != 0)
                    {
                        line = string.Format(CultureInfo.InvariantCulture,
                            ...
                            Math.Abs(HomeLoc.Lat * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                            HomeLoc.Lat < 0 ? "S" : "N",
                            Math.Abs(HomeLoc.Lng * 100).ToString("0.00000", CultureInfo.InvariantCulture),
                    ...
                    line = string.Format(CultureInfo.InvariantCulture, "$GP{0},{1},{2},{3},", "RPY",
                        MainV2.comPort.MAV.cs.roll.ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.pitch.ToString("0.00000", CultureInfo.InvariantCulture),
                        MainV2.comPort.MAV.cs.yaw.ToString("0.00000", CultureInfo.InvariantCulture));
