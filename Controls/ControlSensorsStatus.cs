...
namespace MissionPlanner.Controls
{
    public partial class ControlSensorsStatus : UserControl
    {
        ...
        public void update()
        {
            ...
            {
                if (tableLayoutPanel1.GetControlFromPosition(0, a) != null) continue;

                tableLayoutPanel1.Controls.Add(
                    new Label
                    {
                        Text = name.Replace("MAV_SYS_STATUS", "").Replace("_", " ").Trim(),
                        Font = new Font(Font.FontFamily, 5), Margin = new Padding(0), Padding = new Padding(0)
                    }, 0, a);
                a++;
            }
